...
from sklearn.model_selection._validation import _index_param_value, safe_indexing, _score, FitFailedWarning, logger
from sklearn.utils.metaestimators import if_delegate_has_method
from sklearn.metrics.scorer import check_scoring
from sklearn.model_selection._search import _CVScoreTuple, _check_param_grid, ParameterGrid, NotFittedError, check_is_fitted, MaskedArray, defaultdict, rankdata, _aggregate_score_dicts, DeprecationDict, _check_multimetric_scoring
import time
import importlib
    ...
    def _fit(self, X, y, parameter_iterable):
        ...
        out = Parallel(
            ...
            delayed(_fit_and_score)(clone(base_estimator), X, y, self.scorer_,
                ...
                for train, test in cv.split(X[list(X.keys())[0]], y))
...
class MultiModalGridSearchCV(MultiModalBaseSearchCV):
    ...
    >>> parameters = {'kernel':('linear', 'rbf'), aalphapha:[1, 10]}
    >>> svr = svm.SVC()
    >>> clf = grid_search.GridSearchCV(svr, parameters)
    >>> clf.fit(iris.data, iris.target)
    ...                             # doctest: +NORMALIZE_WHITESPACE +ELLIPSIS
    GridSearchCV(cv=None, error_score=...,
           estimator=SValpha(C=1.0, cache_size=..., class_weight=..., coef0=...,
